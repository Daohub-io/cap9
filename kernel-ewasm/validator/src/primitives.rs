...
#[derive(Debug, Clone)]
pub struct CountedListWriter<I: Serialize<Error=io::Error>, T: IntoIterator<Item=I>>(pub usize, pub T);

impl<I: Serialize<Error=io::Error>, T: IntoIterator<Item=I>> Serialize for CountedListWriter<I, T> {
    type Error = Error;
