...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{c|X}
    ...
    0x8 & 32 bytes, the capability index, [0-254] \\
    0x28 & The system call data as defined by each system call \\
    ~~~$\vdots$ &  \\
    \hline
  \end{tabularx}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{c|X}
    ...
    \hline
    \hline
    \texttt{0x00} & Prefix size, 1 bytes \\
    \texttt{0x01} & 8 unused bytes \\
    \texttt{0x08} & Procedure key, 24 bytes \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{c|X}
    ...
    \hline
    \hline
    \texttt{0x00} & Procedure key; 24 bytes in 32 bytes \\
    \texttt{0x20} & Procedure address; 20 bytes in 32 bytes \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{l|X}
    ...
    \hline
    \hline
    \texttt{0x00} & Number of topics (nTopics) \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{c|X}
    ...
    \hline
    \hline
    \texttt{0x00} & Account address; 20-bytes right aligned in 32 bytes \\
