...
contract BeakerContract {
  ...
  function log0(uint8 capIndex, uint32 value) internal returns (uint8 err) {
      assembly {
            function mallocZero(size) -> result {
                // align to 32-byte words
                let rsize := add(size,sub(32,mod(size,32)))
  ...
  function log1(uint8 capIndex, uint32 t1, uint32 value) internal returns (uint8 err) {
      assembly {
            // First set up the input data (at memory location 0x0)
            // The log call is 0x-09
            mstore(0x0,0x09)
            // The capability index is 0x-01
            mstore(0x20,capIndex)
            // The number of topics we will use
            mstore(0x40,0x1)
            // The first topic
            mstore(0x60,t1)
  ...
  function log2(uint8 capIndex, uint32 t1, uint32 t2, uint32 value) internal returns (uint8 err) {
      assembly {
            // First set up the input data (at memory location 0x0)
            // The log call is 0x-09
            mstore(0x0,0x09)
  ...
  function log3(uint8 capIndex, uint32 t1, uint32 t2, uint32 t3, uint32 value) internal returns (uint8 err) {
      assembly {
            // First set up the input data (at memory location 0x0)
            // The log call is 0x-09
            mstore(0x0,0x09)
  ...
  function log4(uint8 capIndex, uint32 t1, uint32 t2, uint32 t3, uint32 t4, uint32 value) internal returns (uint8 err) {
      assembly {
            // First set up the input data (at memory location 0x0)
            // The log call is 0x-09
            mstore(0x0,0x09)
